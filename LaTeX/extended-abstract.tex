...
\begin{figure}
  \includegraphics[width=0.9\columnwidth]{figures/ea-figure1-sigchi}
...
\marginpar{\vspace{0pc}So long as you don't type outside the right
...
\begin{marginfigure}[-35pc]
  \begin{minipage}{\marginparwidth}
    \centering
    \includegraphics[width=0.9\marginparwidth]{figures/ea-cats}
...
\begin{figure*}
  \centering
  \includegraphics[width=1.4\columnwidth]{figures/ea-map}
