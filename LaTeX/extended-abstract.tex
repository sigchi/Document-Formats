...
\marginpar{\vspace{-2pc}So long as you don't type outside the right
...
exact date; do include the page numbers if available. References
should be in ACM citation format:
