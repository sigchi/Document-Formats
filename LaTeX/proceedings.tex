...
\begin{figure}[h]
\centering
  \alt{SIGCHI logo (using accessibility.sty alt command)}
  \includegraphics[width=0.9\columnwidth]{figures/sigchi-logo}
  \caption{Insert a caption below each figure. Do not alter the
    Caption style.  One-line captions should be centered; multi-line
    should be justified. (using accessibility.sty alt command)}~\label{fig:figure1}
\end{figure}

\begin{figure}[h]
\centering
  {\pdftooltip{\includegraphics[width=0.9\columnwidth]{figures/sigchi-logo}}{SIGCHI logo (using accessibilityMeta.sty pdftooltip solution)}}
  \caption{Insert a caption below each figure. Do not alter the
    Caption style.  One-line captions should be centered; multi-line
    should be justified. (using accessibilityMeta.sty pdftooltip solution)}~\label{fig:figure1}
\end{figure}

\begin{figure}[h]
\centering
\BeginAccSupp{method=pdfstringdef,Alt={SIGCHI logo (using accsupp.sty environment)}}
\includegraphics[width=0.9\columnwidth]{figures/sigchi-logo}
\EndAccSupp{}
  \caption{Insert a caption below each figure. Do not alter the
    Caption style.  One-line captions should be centered; multi-line
    should be justified. (using accsupp.sty environment)}~\label{fig:figure1}
\end{figure}
...
\begin{table}
  ...
  \begin{tabular}{l r r r}
    ...
    %\cmidrule(r){3-4}
    \thead{\small\textit{Name}}
    & \thead{\small \textit{First}}
      & \thead{\small \textit{Second}}
    & \thead{\small \textit{Final}} \\
    \midrule
...
\begin{figure*}
  \centering
\BeginAccSupp{method=pdfstringdef,Alt={Map of the world by ayman, available on Flickr.}}
  \alt{Map of the world by ayman, available on Flickr.}
  {\pdftooltip{\includegraphics[width=1.75\columnwidth]{figures/map}}{Map of the world by ayman, available on Flickr.}}
\EndAccSupp{}
