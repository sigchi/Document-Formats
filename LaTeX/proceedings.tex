...
% have to enable the "draft" option for the document class. To do this, change the very first
% line to: "\documentclass[draft]{sigchi}". You can then place todo notes by using the "\todo{...}"
