...
\usepackage{txfonts}
\usepackage{mathptmx}    %Times New Roman with maths support; comment if you want LaTeX's default font
...
%enable character protrusion and font expansion to have great looking documents
