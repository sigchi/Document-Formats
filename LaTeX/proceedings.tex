...
% remove this for camera ready version:
\toappear{
Submitted to Automotive'UI 17. \\
Limited circulation.\\
For review only.
}

% Copyright -> use this for camera ready version:
%\CopyrightYear{2017}
%\setcopyright{acmlicensed} % this is the standard license
%%\setcopyright{acmcopyright}
%%\setcopyright{rightsretained}
%\conferenceinfo{Automotive'UI 17}{September 24 - 27, 2017, Oldenburg, Germany}
%% ISBN
%\isbn{xxx}
%% DOI
...
\def\plaintitle{AutomotiveUI's Version of the SIGCHI Conference Proceedings Format}
...
\ccsdesc[500]{General and reference~Reference works (See
  \url{http://acm.org/about/class/2012/} for the full list of ACM
  classifiers. This section is required.)}
\printccsdesc
